...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const whereOverlay = document.getElementById('where-overlay');
    const regionItems = document.querySelectorAll('.region-item');

    whereBtn.addEventListener('click', function() {
        whereOverlay.classList.remove('hidden');
    });

    whereOverlay.addEventListener('click', function(e) {
        if (e.target === whereOverlay) {
            whereOverlay.classList.add('hidden');
        }
    });
    ...
    regionItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            whereBtn.textContent = regionName;
            whereOverlay.classList.add('hidden');
        });
    });
});
document.addEventListener('DOMContentLoaded', function() {
    ...
    whereInput.addEventListener('click', function() {
        whereOverlay.classList.remove('hidden');
    });
